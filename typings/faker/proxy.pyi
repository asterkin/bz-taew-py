...
class Faker:
    ...
    def random_choices(
        self,
        elements: Union[Collection[T], OrderedDict[T, float]] = ...,  # type: ignore
        length: Optional[int] = ...,
    ) -> Sequence[T]:
        """
    ...
    def json(
        self,
        data_columns: Optional[List] = ...,  # type: ignore
        num_rows: int = ...,
        indent: Optional[int] = ...,
    ...
    def xml(
        ...
        value_types: Union[List[Type], Tuple[Type, ...], None] = ...,  # type: ignore
        allowed_types: Union[List[Type], Tuple[Type, ...], None] = ...,  # type: ignore
    ) -> str:
        """
        Returns some XML.
    ...
    ) -> Union[bool, str, float, int, tuple, set, list, Iterable, dict, None]:  # type: ignore
        """
    ...
    def __deepcopy__(self, memodict): ...  # type: ignore
